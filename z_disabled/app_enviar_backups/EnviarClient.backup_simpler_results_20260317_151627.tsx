...
<div style={{ gridColumn: "1 / -1" }}>
          ...
          {step === 4 && (
            <div id="clara-results" style={{ display: "grid", gap: 18 }}>
              <Card
                title="O que a Clara encontrou"
                subtitle={hasResult ? "Leia primeiro este resumo. Depois, escolha os pontos que quer usar na sua mensagem ou reclamação." : "Quando a análise terminar, o resumo aparecerá aqui."}
              >
                ...
                {!!findings.length && (
                  <div style={{ marginTop: 10, fontSize: 12, color: COLORS.muted }}>
                    Resumo do nível de atenção: <b>{riskLabel}</b> — Pontuação: <b>{totalPoints}</b>
                  </div>
                )}
              ...
              <Card title="Mensagem para pedir ajuste" subtitle="Use esta mensagem para pedir esclarecimentos, ajustes ou uma nova versão do contrato.">
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  <GhostBtn onClick={openEmail} disabled={!emailDraft}>Abrir no e-mail</GhostBtn>
                  <GhostBtn onClick={copyEmail} disabled={!emailDraft}>Copiar para enviar</GhostBtn>
                </div>
              ...
              <Card
                title="Se não resolver, use este texto para reclamar"
                subtitle="Este texto já sai em tom mais direto para Consumidor.gov.br, Reclame Aqui ou Procon. Ele fica mais forte quando você adiciona os pontos acima."
              >
                ...
                <div style={{ display: "grid", gap: 12 }}>
                  <div style={{ padding: 12, borderRadius: 14, border: "1px solid #EEF0F3", background: COLORS.soft2 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center" }}>
                      <div style={{ fontWeight: 900 }}>Texto para registrar sua reclamação</div>
                      <button
                        onClick={async () => {
                    ...
                    <div style={{ marginTop: 8, fontSize: 12, color: COLORS.muted }}>
                      Dica: clique em “Usar este ponto” nos pontos mais importantes para deixar sua reclamação mais forte e objetiva.
                    </div>
                  </div>
