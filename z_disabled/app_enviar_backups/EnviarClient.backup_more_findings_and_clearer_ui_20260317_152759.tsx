          ...
          {step === 4 && (
            <div id="clara-results" style={{ display: "grid", gap: 18 }}>
              <Card
                ...
                subtitle={hasResult ? "Aqui está o resumo do contrato em linguagem simples. Depois, você pode usar os pontos mais importantes para se proteger melhor." : "Quando a análise terminar, o resumo aparecerá aqui."}
              >
                ...
                {!!findings.length && (
                  <div style={{ marginTop: 10, fontSize: 12, color: COLORS.muted }}>
                    Nível de atenção do contrato: <b>{riskLabel}</b> — Pontuação: <b>{totalPoints}</b>
                  </div>
                )}
                    ...
                    {findings.slice(0, 10).map((f, idx) => (
                      <div key={idx} style={{ padding: 12, borderRadius: 14, border: "1px solid #EEF0F3", background: COLORS.soft2 }}>
                        ...
                        <div style={{ marginTop: 8, color: COLORS.text, lineHeight: 1.5 }}>
                          <b>Por que isso merece atenção:</b> {f.whyItMatters}
                        </div>
                        <div style={{ marginTop: 6, color: COLORS.text, lineHeight: 1.5 }}>
                          <b>Como se proteger:</b> {f.whatToDo}
                        </div>
                        {f.legalHint && (
              ...
              <Card title="Mensagem para pedir revisão" subtitle="Se quiser tentar resolver primeiro, use esta mensagem pronta para pedir revisão do contrato.">
              ...
              <Card
                title="Se não resolver, use esta reclamação pronta"
                subtitle="Se a empresa não ajustar o contrato, copie este texto e use no Consumidor.gov.br, Reclame Aqui ou Procon."
              >
                ...
                <div style={{ display: "grid", gap: 12 }}>
                  <div style={{ padding: 12, borderRadius: 14, border: "1px solid #EEF0F3", background: COLORS.soft2 }}>
                    ...
                    <div style={{ marginTop: 8, fontSize: 12, color: COLORS.muted }}>
                      Dica: clique em “Adicionar” nos pontos mais importantes para deixar sua reclamação mais forte e objetiva.
                    </div>
                  </div>
                </div>
              </Card>
