          ...
          {step === 4 && (
            <div id="clara-results" style={{ display: "grid", gap: 18 }}>
              <Card
                ...
                subtitle={hasResult ? "Aqui estão os pontos mais importantes do contrato, em linguagem simples." : "Quando a análise terminar, os pontos mais importantes aparecerão aqui."}
              >
                ...
                {!!findings.length && (
                  <div style={{ marginTop: 10, fontSize: 12, color: COLORS.muted }}>
                    Sinal de atenção do contrato: <b>{riskLabel}</b> — Pontuação: <b>{totalPoints}</b>
                  </div>
                )}
              ...
              <Card title="Mensagem pronta para enviar" subtitle="Você pode abrir no seu e-mail já preenchido ou copiar a mensagem.">
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  <GhostBtn onClick={openEmail} disabled={!emailDraft}>Abrir no seu e-mail</GhostBtn>
                  <GhostBtn onClick={copyEmail} disabled={!emailDraft}>Copiar mensagem</GhostBtn>
                </div>
              ...
              <Card
                title="Próximo passo: reclamar ou pedir ajuste"
                subtitle="Use este texto pronto para Consumidor.gov.br, Reclame Aqui ou Procon. Você pode personalizar com os pontos que marcou acima."
              >
                ...
                <div style={{ display: "grid", gap: 12 }}>
                  <div style={{ padding: 12, borderRadius: 14, border: "1px solid #EEF0F3", background: COLORS.soft2 }}>
                    <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "center" }}>
                      <div style={{ fontWeight: 900 }}>Texto pronto para copiar e colar</div>
                      <button
                        onClick={async () => {
                    ...
                    <div style={{ marginTop: 8, fontSize: 12, color: COLORS.muted }}>
                      Dica: clique em “Adicionar ao texto pronto” nos pontos mais importantes para deixar sua reclamação mais forte e objetiva.
                    </div>
                  </div>
