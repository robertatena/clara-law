    ...
    <main style={{ fontFamily: "'Montserrat', sans-serif", background: "#F8F7F4", minHeight: "100vh", paddingTop: 64 }}>
      ...
      <section style={{ background: "#1a2340", padding: "80px 24px" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 12, color: "rgba(168,216,240,0.55)", marginTop: 16 }}>Sem cartão · Sem cadastro obrigatório</p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 16 }}>
          ...
          <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
            {[
              ...
              <a key={l.label} href={l.href} style={{ fontSize: 12, color: "rgba(168,216,240,0.7)", textDecoration: "none" }}>{l.label}</a>
            ))}
          </div>
        </div>
